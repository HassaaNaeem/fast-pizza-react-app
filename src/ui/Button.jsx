...
function Button({ children, disabled, to, type }) {
  ...
  const styles = {
    ...
    secondary:
      "inline-block rounded-full text-sm border-2 border-stone-300 font-semibold tracking-wide text-stone-400 uppercase transition-colors duration-300 hover:bg-stone-300 hover:text-stone-800 focus:text-stone-800 focus:bg-stone-300 focus:ring focus:ring-stone-200 focus:ring-offset-2 focus:outline-none disabled:cursor-not-allowed px-4 py-2.5 sm:px-6 sm:py-3.5",
  };
  if (to) {
    return (
